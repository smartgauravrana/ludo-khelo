...
export const postResult =
  (postData, cbSuccess, cbError) => async (dispatch) => {
    try {
...
export const postMatch =
  (match, cbSuccess, cbError) => async (dispatch, getState) => {
    try {
      const res = await call({
        method: "post",
...
export const getMatch =
  (matchId, cbSuccess, cbError) => async (dispatch, getState) => {
    try {
...
export const getAllMatches =
  (cbSuccess, cbError) => async (dispatch, getState) => {
...
export const acceptInvite =
  ({ match, roomId }, cbSuccess, cbError) =>
