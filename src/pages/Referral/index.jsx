...
function Referral({ settings, userDetails, getReferrals }) {
  ...
  const message = shareMessage
    ? shareMessage.replace("REFER_CODE", userDetails.referCode)
    : "";

  function updateClipboard() {
    setTooltipVisible(true);
    setTimeout(() => setTooltipVisible(false), 900);
    navigator.clipboard.writeText(userDetails.referCode).then(
      function () {
  ...
  return (
    <div className="Referral">
      ...
      <div className="Referral__Share">
        <div
          className="Referral__ShareTitle"
      ...
      <div className="Referral__Invites">
        Invites accepted:{" "}
        <span className="Referral__Count">{userDetails.referralsCount}</span>
      </div>
